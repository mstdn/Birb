                ...
                <path
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <h1 class="text-white text-2xl">Login on birb</h1>
                                ...
                                <input id="password" type="password" placeholder="Password" class="w-full p-2 bg-gray-900 rounded-md border border-gray-700 @error('password') is-invalid @enderror" name="password" required autocomplete="current-password">
                    ...
                    <p>No account yet? 
                        <a class="font-semibold text-sky-700" href="/register">Signup now</a> </p>
                </div>
